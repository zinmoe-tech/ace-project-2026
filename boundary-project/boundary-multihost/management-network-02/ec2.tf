...
#intermediate-worker-02's auth_request_token over SSH (see
...
resource "aws_instance" "bastion" {
  ...
  tags = merge(var.tags, {
    Name = "intermediate-worker-02-bastion"
  })
}
...
#purpose : this is for creating the intermediate-worker-02 EC2 instance in
