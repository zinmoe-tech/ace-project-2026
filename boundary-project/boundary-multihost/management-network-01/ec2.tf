...
#intermediate-worker-01's auth_request_token over SSH (see
...
resource "aws_instance" "bastion" {
  ...
  tags = merge(var.tags, {
    Name = "intermediate-worker-01-bastion"
  })
}
...
#purpose : this is for creating the intermediate-worker-01 EC2 instance in
